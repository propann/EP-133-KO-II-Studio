...
| Q-07 | Rapport de progression par pad après une session Rhythm Hero | RETENU | Différenciant fort face à Melodics (générique, ne connaît pas les projets réels) ; prérequis désormais rempli (12 août, dix styles à 5 niveaux écrits à la main), le rapport lui-même reste à construire |
