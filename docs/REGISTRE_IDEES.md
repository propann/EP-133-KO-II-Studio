...
| R-06 | Intégrer `wavesurfer.js` pour la forme d'onde/trim | RETENU | Pas encore commencé ce 13 août — nécessite l'UI de trim de la Phase 4, plus gros chantier que R-04/R-05/R-08, différé à une session dédiée |
